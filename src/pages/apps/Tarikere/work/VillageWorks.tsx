...
export default function VillageWorks() {
  ...
  return (
   <div className="flex flex-col h-[calc(100vh-270px)] bg-white rounded-lg overflow-hidden">
  ...
  <div className="sticky top-0 z-10 bg-white p-2 border-b">
    ...
    <div className="flex gap-2 flex-col sm:flex-row">
      <button
        ...
        className={`w-full sm:w-auto px-4 py-1 text-[11px] sm:text-[13px] rounded-lg ${
